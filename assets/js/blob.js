...
const standardBlobSize = w / 3;
const blobSize = standardBlobSize;
...
function setup() {
    ...
    backgroundShader = shaderGraphics.createShader(
        vertexShader,
...
function draw() {
    ...
    shaderGraphics.sphere(w / 6, 200, 100);
...
function windowResized() {
    const b = document.getElementById("sketch-holder");
