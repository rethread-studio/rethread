...
export default class AboutView {
    ...
    render() {
        ...
        <div class="flex flex-col m-auto  w-4/5">
            <div class="grid grid-cols-1 sm:grid-cols-2 p-0 sm:p-24 pt-28 sm:pt-40">
                <div class="p-0 sm:pr-20 ">
                    <img class="h-auto .max-727 blur" src="./img/imgTest.png" alt="yahoo profile test">
                </div>
                <div class="container white  mt-4 sm:mt-0">
                    <h1 class= "text-center sm:text-left text-4xl sm:text-8xl mb-6 sm:mb-12" >About<br> re|thread</h1>
        ...
        <h2 class= "text-3xl mt-6 sm:mt-0 mb-6 sm:mb-12 text-center white" >Who we are</h2>
       <div class="flex flex-col sm:flex-row justify-center content-center">
         <div class="flex flex-col  sm:w-1/4 mt-6 sm:mt-0 text-center content-center">
       ...
       <h2 class= "text-3xl mb-6 sm:mb-12 text-center white mt-6 sm:mt-20" >Acknowledgments</h2>
       <div class="flex flex-row justify-center content-center mb-6 sm:mb-10 space-x-10">
