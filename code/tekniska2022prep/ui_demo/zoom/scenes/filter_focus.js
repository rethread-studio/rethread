  function full_size_zoom(canvas, img) {
    let w_zoom = canvas.clientWidth / img.width;
    let h_zoom = canvas.clientHeight / img.height;
    return Math.min(w_zoom, h_zoom);
  }
  ...
  `;
      ...
      let zoom = full_size_zoom(this.canvas, this.img);
