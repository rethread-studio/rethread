...
class VisualIntro {
    ...
    drawImages() {
        ...
        image(this.logoNobel, this.positions.row.r1 + 4 * subsampling, this.positions.col.c5 + 3, imgSize.x * subsampling, imgSize.y * subsampling);
        image(this.logoKTH, this.positions.row.r3 - 44 * subsampling, this.positions.col.c5 + 3 * subsampling, imgSize.x * subsampling, imgSize.y * subsampling);
        image(this.logoRethart, this.positions.row.r3 - 47 * subsampling, this.positions.col.c4 + 11 * subsampling, 46.25 * subsampling, 8.96 * subsampling);
    }
