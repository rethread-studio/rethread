...
tmux send-keys -t $session:$window "cd /home/reth/Documents/rethread/code/NWL2022/data_exploration/led_matrix_simulator && cargo run --release -- --trace /home/reth/Documents/unfold_traces/data-varna-startup-shutdown --osc --headless
" C-m
tmux split-window -t $session:$window -v
