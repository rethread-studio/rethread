...
tmux split-window -t $session:$window -v
sleep 3
tmux send-keys -t $session:$window "cd /home/reth/Documents/rethread/code/NWL2022/rust/unfold_control && cargo run --release -- --trace /home/reth/Documents/unfold_traces/data-jedit-with-marker --osc --headless
" C-m
