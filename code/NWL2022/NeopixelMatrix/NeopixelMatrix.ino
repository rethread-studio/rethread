...
void swipes() {
 ...
 for(int i = 0; i < 10; i++) {
  for(int k = 0; k < 10; k++) {
    int index = xy_to_pixel(k, i);

    strip.setPixelColor(index, strip.gamma32(strip.ColorHSV(g_hue, 0, 255)));
  }
  strip.show();
  g_hue += 100;
  delay(wait);
 ...
 for(int i = 0; i < 10; i++) {
  for(int k = 0; k < 10; k++) {
    int index = xy_to_pixel(i, k);
    strip.setPixelColor(index, strip.gamma32(strip.ColorHSV(g_hue, 255, 255)));
  }
  strip.show();
    g_hue =g_hue + 100;
